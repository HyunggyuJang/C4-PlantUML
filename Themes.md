...
(e.g. theme [`C4_united`](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_united.puml)
...
```plantuml
!theme C4_united from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
!RELATIVE_INCLUDE = "https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error"
...
Theme [C4_blue](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_blue.puml) can be activated with

```plantuml
!theme C4_blue from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4_brown](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_brown.puml) can be activated with

```plantuml
!theme C4_brown from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4_green](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_green.puml) can be activated with

```plantuml
!theme C4_green from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4_sandstone](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_sandstone.puml) can be activated with

```plantuml
!theme C4_sandstone from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4_superhero](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_superhero.puml) can be activated with

```plantuml
!theme C4_superhero from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4_united](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_united.puml) can be activated with
...
Theme [C4_violet](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4_violet.puml) can be activated with

```plantuml
!theme C4_violet from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
@startuml
 ...
 ' !theme C4Language_japanese from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
 !include https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/C4_Container.puml
...
Theme [C4Language_english](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_english.puml) can be activated with

```plantuml
!theme C4Language_english from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_chinese](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_chinese.puml) can be activated with

```plantuml
!theme C4Language_chinese from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_danish](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_danish.puml) can be activated with

```plantuml
!theme C4Language_danish from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_dutch](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_dutch.puml) can be activated with

```plantuml
!theme C4Language_dutch from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_german](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_german.puml) can be activated with

```plantuml
!theme C4Language_german from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_italian](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_italian.puml) can be activated with

```plantuml
!theme C4Language_italian from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_japanese](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_japanese.puml) can be activated with
...
Theme [C4Language_korean](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_korean.puml) can be activated with

```plantuml
!theme C4Language_korean from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_portuguese](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_portuguese.puml) can be activated with

```plantuml
!theme C4Language_portuguese from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_russian](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_russian.puml) can be activated with

```plantuml
!theme C4Language_russian from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_spanish](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_spanish.puml) can be activated with

```plantuml
!theme C4Language_spanish from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
...
Theme [C4Language_ukrainian](https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes/puml-theme-C4Language_ukrainian.puml) can be activated with

```plantuml
!theme C4Language_ukrainian from https://raw.githubusercontent.com/HyunggyuJang/C4-PlantUML/feature/patch-handwritten-error/themes
```
